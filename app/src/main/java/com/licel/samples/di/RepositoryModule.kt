...
import com.licel.samples.data.OtpPreferencesRepositoryImpl
import dagger.Binds
...
interface RepositoryModule {
    @Binds
    fun otpPreferencesRepository(otpPreferencesRepository: OtpPreferencesRepositoryImpl): OtpPreferencesRepository
}