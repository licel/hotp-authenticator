...
//
package com.licel.samples.applet;
...
public class OTPApplet extends Applet {
    ...
    OTPApplet(byte[] bArray, short bOffset, byte bLength) {
        ...
        sigEngineSHA1 = Signature.getInstance(Signature.ALG_HMAC_SHA1, false);
        sigEngineSHA256 = Signature.getInstance(Signature.ALG_HMAC_SHA_256, false);
        sigEngineSHA384 = Signature.getInstance(Signature.ALG_HMAC_SHA_384, false);
        sigEngineSHA512 = Signature.getInstance(Signature.ALG_HMAC_SHA_512, false);
